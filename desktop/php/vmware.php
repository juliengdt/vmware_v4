...
<div class="row row-overflow">
 <div class="col-lg-12 eqLogicThumbnailDisplay">
  ...
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation"><a href="#commandtab" aria-controls="profile" role="tab" data-toggle="tab"><i class="far fa-list-alt"></i> {{Commandes}}</a></li>
  </ul>
		 ...
		 <div class="col-sm-4">
          <form class="form-horizontal">
            <fieldset>
              ...
              <div class="form-group">
                <label class="col-sm-6 control-label" id="ipAddressLabelRightPartOfPage">{{Adresse IP}}</label>
                <div class="col-sm-2">
